...
let BkShopping: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      <Path
        ...
        fill={getIconColor(color, 0, '#e98f36')}
      />
    </Svg>
  );
};

BkShopping.defaultProps = {
  size: 18,
};

BkShopping = React.memo ? React.memo(BkShopping) : BkShopping;

export default BkShopping;

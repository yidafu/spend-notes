...
let BkMedicine: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      ...
      <Path
        ...
        fill={getIconColor(color, 1, '#dd6572')}
      />
    </Svg>
  );
};

BkMedicine.defaultProps = {
  size: 18,
};

BkMedicine = React.memo ? React.memo(BkMedicine) : BkMedicine;

export default BkMedicine;

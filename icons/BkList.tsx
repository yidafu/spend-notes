...
let BkList: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
    <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
      ...
      <Path
        ...
        fill={getIconColor(color, 4, '#7cb305')}
      />
      <Path
        ...
        fill={getIconColor(color, 5, '#7cb305')}
      />
    </Svg>
  );
};
...
BkList = React.memo ? React.memo(BkList) : BkList;

...
let BkChartLite: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
BkChartLite.defaultProps = {
  size: 18,
};

BkChartLite = React.memo ? React.memo(BkChartLite) : BkChartLite;

export default BkChartLite;
